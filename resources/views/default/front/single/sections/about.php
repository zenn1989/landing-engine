    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="badges">
                    <a class="badge-link" href="#"><img src="<?= url('/') ?>/assets/img/company-process-image1.jpg" alt=""></a>
                    <a class="badge-link" href="#"><img src="<?= url('/') ?>/assets/img/company-process-image2.jpg" alt=""></a>
                </div>
            </div>
        </div>
    </div>
